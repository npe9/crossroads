...
! nstg             - number of KBA stages per octant-pair sweep
...
! corner_loop_order(4) - corsweep corner loop priortized order
!_______________________________________________________________________
  ...
  INTEGER(i_knd) :: ncor, nops, nstg, last_oct, corner_sch(2,4)

  INTEGER(i_knd), DIMENSION(4) :: yzstg, corner_loop_order
